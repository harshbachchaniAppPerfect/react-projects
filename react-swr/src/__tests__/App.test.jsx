...
// test("testing mock api get todos", async () => {
//   render(<App />);
//   const ele = await screen.findAllByTestId("todos", {}, { timeout: 1500 });

//   expect(ele).toHaveLength(4);
// });
test("testing api get todos", async () => {
  render(<App />);
  const ele = await screen.findAllByTestId("todos", {}, { timeout: 1500 });
